...
namespace ZiraLink.Api.Application.Services
{
    public interface IProjectService
    {
        ...
        Task<Guid> CreateAsync(long id, string title, DomainType domainType, string domain, string internalUrl, RowState state, CancellationToken cancellationToken);
        Task DeleteAsync(long customerId, long id, CancellationToken cancellationToken);
        Task PatchAsync(long id, long customerId, string title, DomainType domainType, string domain, string internalUrl, RowState state, CancellationToken cancellationToken);
    }
}
